...
public class MovieService {
    ...
    @SPDocConsumer(tag = "电影", value = "创建电影")
    @Queue("movie.admin.create")
    public ImplResponse<Boolean> createMovie(@Body MovieCreateDto movieCreateDto) {
        movieRepository.save(movieMapper.createDtoToEntity(movieCreateDto));
        return ImplResponse.of(true);
    }


    @SPDocConsumer(tag = "电影", value = "删除电影")
    @Queue("movie.admin.delete")
    public ImplResponse<Boolean> deleteMovie(@Body Long movieId) {
    ...
    @SPDocConsumer(tag = "电影", value = "修改电影")
    ...
    @SPDocConsumer(tag = "电影", value = "电影列表")
    @Queue("movie.admin.get")
    ...
    @SPDocConsumer(tag = "电影", value = "电影单个查询")
    @Queue("movie.admin.get")
    public ImplResponse<MovieCommonDto> one(@Body Long id) {
